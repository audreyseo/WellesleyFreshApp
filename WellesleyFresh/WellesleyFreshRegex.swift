...
class WellesleyFreshRegex {
	...
	var bodyRegex: NSRegularExpression? {
		return try! NSRegularExpression(pattern: bodyExtraction, options: NSRegularExpressionOptions.DotMatchesLineSeparators)
	}
	var spanDeleterRegex: NSRegularExpression? {
		return try! NSRegularExpression(pattern: spanDeletionPattern, options: NSRegularExpressionOptions.DotMatchesLineSeparators)
	}
	var elementDeleterRegex:NSRegularExpression? {
		return try! NSRegularExpression(pattern: allElementDeletion, options: NSRegularExpressionOptions.DotMatchesLineSeparators)
	}
	...
	func extractInformationString(input:String) -> String {
