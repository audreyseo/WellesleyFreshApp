...
//		}
	...
	override func setupViews() {
		...
		let timeWidth = 50
		addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-16-[v0(\(hallNameWidth))]-4-[v1(40)]-8-[v2(<=\(timeWidth))]-4-[v3(<=80)]-4-[v4(<=\(timeWidth))]-16-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0": nameLabel, "v1": mealLabel, "v2": timeLabel, "v3": progress, "v4": timeLeft]))
